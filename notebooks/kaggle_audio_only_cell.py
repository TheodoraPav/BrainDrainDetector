# ========== BrainDrainDetector — Kaggle ONE CELL: AUDIO-ONLY ==========
#
# Single run → pooled baseline trained with biosignals zeroed (audio_only).
...
# =============================================================================
# USER SETTINGS — audio-only (do not change unless you know why)
# =============================================================================
INPUT_MODALITY = "audio_only"
ZIP_OUTPUT_NAME = "results_classification_cross_attn_pooled_audio_only_weighted_no_aug.zip"

CELL_VERSION = "2026-06-11-audio-only-macro-f1"
print(f"BrainDrainDetector Kaggle audio-only cell {CELL_VERSION}")
...
if SAVE_RESULTS_ZIP:
    ...
    print("Save locally to results/results_classification_cross_attn_pooled_audio_only_weighted_no_aug/")

print("\n[Kaggle] AUDIO-ONLY DONE.")
